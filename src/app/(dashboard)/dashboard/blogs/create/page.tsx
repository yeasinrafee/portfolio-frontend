...
export default function CreateBlogPage() {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast.error(errorMsg || 'Failed to create blog post');
    } finally {
      setIsLoading(false);
    }
  }
        ...
        <div className='flex items-center gap-4'>
          ...
          <div>
            ...
            <p className='text-sm text-muted-foreground'>
              Write content and manage metadata for your blog post.
            </p>
          </div>
        </div>
      </div>
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Input
                              placeholder='javascript, webdev, backend'
                              {...field}
                            />
                          </FormControl>
                          <FormMessage />
          ...
          <div className='flex justify-end gap-4 mt-8 pt-4'>
            ...
            >
              {isLoading ? (
                ...
                <>
                  <Save className='w-4 h-4 mr-2' /> Save Blog Post
                </>
              )}
            </Button>
          </div>
